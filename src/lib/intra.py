#
# Modified from Hive Helsinki
# https://github.com/hivehelsinki/42api-lib
# Commit a26c11588c5df7168470bbf1c2760456001e250e
#
# Changes in this file:
# - removed yaml config requirement, using existing config from the Improved Intra 42 server repository
...
class IntraAPIClient(object):
	...
	def __init__(self, progress_bar=False):
		...
		self.api_url = config['INTRA_API_URL']
		self.scopes = 'public'
